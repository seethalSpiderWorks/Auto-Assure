                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right d-flex align-items-center" style="gap:.5rem;">
                        ...
                        @unless($inspection->isCancelled())
                            <a href="{{ $inspection->reportUrl() }}" target="_blank" class="btn btn-sm insp-hlbtn insp-hlbtn--report"><i class="bx bx-download"></i> Download Report</a>
                            @include('inspections._client_report_link', ['btnClass' => 'btn btn-sm insp-hlbtn'])
                        @endunless
