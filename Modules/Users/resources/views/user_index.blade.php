        ...
        <div class="container-fluid">
                                ...
                                <div class="">
									...
									<input type='hidden' name='_token' value='{{csrf_token()}}'> 
										<div class="row"> 
											...
											<div class="col-md-3" > 
												<div class="mb-3">
													<label class="form-label">User Name<span class="star_required" style="color:red"> *</span></label>
													<input type="text" name="user_name" required='required' data-parsley-required-message='User Name Required' class='form-control' id='user_name' data-parsley-minlength='3' placeholder="User Name"> 
                                            ...
                                            <div class="col-md-3" > 
												<div class="mb-3">
													...
													<span id="user_fname-parsley-error"></span>
													<span class="highlight"></span>
												</div>
											</div>
											...
											<div class="col-md-3">
												<div class="mb-3">
													<label class="form-label">Last Name<span class="star_required" style="color:red"> *</span></label>
											...
											<div class="col-md-3" > 
												<div class="mb-3">
													...
													<span id="user_email-parsley-error"></span>
													<span class="highlight"></span>
											...
											<div class="col-md-3">
												<div class="mb-3">
													<label class="form-label">Address<span class="star_required" style="color:red"> *</span></label>
											...
											<div class="col-md-3">
												<div class="mb-3">
													<label class="form-label">Designation<span class="star_required" style="color:red"> *</span></label>
											...
											<div class="col-md-3">
												<div class="mb-3">
												<label>Privilage<span class="star_required" style="color:red"> *</span></label>
                                        ...
                                        @if(Auth::user()->previlage == 2)   
											...
											<div class="col-md-3" id="center_div_main">
												<div class="mb-3">
												<label> Branch<span class="star_required" style="color:red"> *</span></label>
											 ...
											 <div class="col-md-3" style="display:none;" id="center_div" >
												<div class="mb-3">
												<label> Centre<span class="star_required" style="color:red"> *</span></label>
                                        ...
                                        @endif
											...
											<div class="col-md-3 user_password"> 
												<div class="mb-3">
													<label> Password<span class="star_required" style="color:red"> *</span></label>
			...
			<div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <!--h4 class="card-title">View Users</h4><p class="card-title-desc"></p-->
...
<script src="{{asset('module.js/Users/index.js?ver=1.6')}}"></script>
