...
<script type="text/javascript">
  ...
  var url_setfilter_campaign = "{{url('/leads/setFilterCampaign')}}";
		...
		<script src="{{asset('module.js/Leads/index.js?ver=1.8')}}"></script>  
