				...
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<p class="card-text"><b>Mobile</b> : +{{$data->breg_mob_code}} {{$data->breg_mob}}</p>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-3" id="lead_in"> <?php
									...
									if($followlead)
									{
										...
										{
											$status = $followlead->lead_assigned_status;  // dd($status);
											if($status == 'Assign')
											{
											...
											{
											 $leadstatus = '<p class="card-text"><b>Status </b>: <span class="btn btn-danger" style="cursor: auto !important;padding: 1px; min-width: 50px;">Inspection Completed</span></p>';
											}	
							    ...
							    if($package != null)
							    {   ?>
							        <h4 clss="card-title"> Payment Summary </h4> <?php
								...
								<div class="col-md-2">
									<div class="mb-2">
										...
										$lead_Status = DB::table('tbl_lead')
											->where('lead_id',$data->lead_id)
											->where('lead_status',0)
											->first();  // dd($lead_Status->lead_followup_type);
