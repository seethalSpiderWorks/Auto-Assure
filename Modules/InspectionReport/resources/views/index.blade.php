						...
						<div class="row authentication-form mx-auto">
							...
							<ul class="nav nav-tabs w-100" id="myTab" role="tablist">
								...
								//if(Auth::user()->user_branch != 39) { ?>
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="specification-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="specification">VEHICLE SPECIFICATION</a>
									</li>
									
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="checklist-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="checklist"> INSPECTION CHECKLIST </a>
									</li>
									<?php 
								//}
								//else { ?>
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="saudi-checklist-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="saudi-checklist"> SAUDI INSPECTION CHECKLIST </a>
									</li>
									<?php
								//} ?> 
 								
 								<li class="nav-item" role="presentation">
									<a class="nav-link" id="summary-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="summary"> SUMMARY </a>
								</li>
								
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="overview-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="overview"> OVERVIEW </a>
								</li>
								
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="reports-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="reports" aria-selected="false">REPORTS</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="gallery-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="gallery" aria-selected="false">GALLERY</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="damages-tab" data-bs-toggle="tab" href="#" role="tab" aria-controls="damages" aria-selected="false">DAMAGES</a>
								</li>
							</ul>    
										...
										<div class="row"> 
                                            ...
                                            <div class="col-md-3" style="margin-top:25px"> <!-- saveButton -->
                                                <div class="mb-3">
													...
													@php
														$checklistType = Auth::user()->user_branch != 39 ? 'specification' : 'saudi-checklist';
													@endphp

													<a href="#" id="saveNextButton" onclick="insertEntry('{{ URL::to("inspectionreport/addVehicleInfo") }}', 'vehicleForm', 'add-modal', 'inspectionReportDataTable', '', true, '{{ $checklistType }}')" class="btn btn-info btn-block"> Save & Next </a>
                                                </div>
                                            </div> 
							...
							//if(Auth::user()->user_branch == 39) { ?>
								<!----- Saudi checklist --->
								@include("inspectionreport::saudi-checklist-index")   
								<!----- Saudi checklist --->
								<?php	
							//}
							//else { ?> 
								...
								<div class="tab-pane fade" id="specification" role="tabpanel" aria-labelledby="specification-tab">
									...
									<form class="myform" method="post" id="specificationForm">
										...
										<div class="row"> 
											...
											<div class="col-sm-2">
                                                <div class="mb-3"> 
													<label for="anti_lock_brakes" style="color:#37458b">{{__('Anti-Lock Brakes (ABS)')}}<span class="text-red"> </span></label> <br>
											...
											<div class="col-sm-2">
                                                <div class="mb-3"> 
													<label for="ebd" style="color:#37458b">{{__('EBD')}}<span class="text-red"> </span></label> <br>
											...
											<div class="col-sm-2">
                                                <div class="mb-3"> 
													<label for="alarm" style="color:#37458b">{{__('Alarm')}}<span class="text-red"> </span></label> <br>
											...
											<div class="col-sm-3">
                                                <div class="mb-3"> 
													...
													<input type="text" id="anti_glare_rear_view_cmnt" name="anti_glare_rear_view_cmnt" class="form-control" placeholder="Comments" style="display:none"> 
												</div>
											</div>
										...
										<div class="row"> 
											...
											<div class="table-responsive m-t-40">   
												...
												<div class="col-md-3" style="margin-top:25px"> <!-- saveButton -->
													<div class="mb-3">
														@php
															$checklistType2 = Auth::user()->user_branch != 39 ? 'checklist' : 'saudi-checklist';
														@endphp   
													
														<a href="#"  onclick="backToTab('summaryForm','{{ $checklistType2 }}')" style="background-color: #10707f;" class="btn btn-info btn-block"><i class="fa fa-arrow-left"></i> Back</a> &nbsp;
...
<script src="{{asset('module.js/main.js?ver=1.5')}}"></script>
<script src="{{asset('module.js/InspectionReport/index.js?ver=5.4')}}"></script>
...
<script type="text/javascript">
    ...
    background.src = "https://crm.auto-assure.com/assets/images/newcar-08022025.png";
...
{    
	...
	//var pngUrl = canvas.toDataURL("https://auto-assure.com/crm/uploads/inspectionreport/damages");  
	var pngUrl = canvas.toDataURL("https://crm.auto-assure.com/uploads/inspectionreport/damages");
...
$('.paddle_shifters').click(function()
{
	...
	{
		$("#paddle_shifters_cmnt").css("display", "none");
	}
});
