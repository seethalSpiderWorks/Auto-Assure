	...
	{ 
		...
		<div class="row"> <?php
			...
			{ ?> 
				...
				<div class="col-sm-2"> 
					<a href="https://crm.auto-assure.com/uploads/inspectionreport/gallery/<?php echo $gallery->gallery_image;?>" title="Image" target="_blank"><img style="width:150px;height:150px;" class="img-circle" src="https://crm.auto-assure.com/uploads/inspectionreport/gallery/<?php echo $gallery->gallery_image;?>" style="max-width:100%"> </a> &nbsp;
...
<table class="table tbl-u-boarderd" style="display:none;">
	...
	foreach($insp_gallery as $gallery)
	{ ?>
		<!--<a href="https://crm.auto-assure.com/uploads/inspectionreport/gallery/<?php echo $gallery->gallery_image;?>" title="Image" target="_blank"><img style="width:100px;height:100px;" class="img-circle" src="https://crm.auto-assure.com/uploads/inspectionreport/gallery/<?php echo $gallery->gallery_image;?>" style="max-width:100%"></a> --> &nbsp; <?php
	}?>
</table>
<p class="hr" style="border-top: black thin dotted;margin-top: 10px;margin-bottom: 10px;"></p>
...
<!--------------- DAMAGES START --------------->	
	...
	<table class="table tbl-u-boarderd">
		...
		{ ?>
		     <h4> Damages </h4>
			 <a href="https://crm.auto-assure.com/uploads/inspectionreport/damages/<?php echo $damages->damage_image;?>" title="Image" target="_blank"><img style="width:250px;height:250px;" class="img-circle" src="https://crm.auto-assure.com/uploads/inspectionreport/damages/<?php echo $damages->damage_image;?>" style="max-width:100%"></a> &nbsp;
			 <?php
		}?>
	</table>	
<!------------------------------>	