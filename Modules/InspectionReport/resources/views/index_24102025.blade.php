												...
												<table class="mytable table table-bordered table-hover   no-footer" id="interestItemTable_summary">
													...
													<tbody id="interest_tbody_summary">
														<tr id="interest_tr_3">
															...
															<td class="remove_new_row_summary center" title="Remove Name" onclick="remove_row_interest_summary('1')">
													...
													<table class="mytable table table-bordered table-hover   no-footer" id="interestItemTable_gallery">
														...
														<tbody id="interest_tbody_gallery">
															<tr id="interest_tr_4">
																...
																<td class="remove_new_row_gallery center" title="Remove Name" onclick="remove_row_interest_gallery('1')">
																	<i class="fa fa-times" aria-hidden="true"></i>
																</td>
															</tr>
														</tbody>
...
<script src="{{asset('module.js/InspectionReport/index.js?ver=3.6')}}"></script>
