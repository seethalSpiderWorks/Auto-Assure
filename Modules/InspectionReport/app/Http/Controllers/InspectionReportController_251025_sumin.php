...
{	
			...
			if($extra_type[0] != null)
			{
				...
				if($count_int>0)
				{
					...
					{  
						...
						$desc_ar = trim($request->extra_name_ar[$i]); // Arabic name
	...
	public function getDivisionAction(Request $request)
    {
        ...
        $report = DB::table('tbl_report')
			->select('report_id','report_reference_no','report_client_name','report_client_name_ar','report_date_of_inspection','report_vehicle_plate_no')
