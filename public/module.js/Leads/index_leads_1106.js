...
var dTable = $('#lead_table').DataTable({
    ...
    "fnCreatedRow": function (nRow, aData, iDataIndex) 
    {
		...
		{
			if(url == 'https://auto-assure.com/crm/myleads/get-list')
			{
				action += '&nbsp <a href="#" onclick='+ editFunction +' title="Edit"><i class="far fa-edit" style="color:green"></i></a>';
			}
			else
			{
				action += '&nbsp <a href="leads?id='+aData.lead_id+'" onclick='+ editFunction +' title="Edit" target="_blank"><i class="far fa-edit" style="color:green"></i></a>';
			}
		}
